...
@section('content')
    ...
    <section class="rrss-banner container mx-auto py-14 px-4">
        ...
        <div class="grid grid-cols-1 grid-rows-3 mb-8">
            <div class="img-container mb-8 border border-black-100 rounded-md">
                <img 
                    src="{{ asset('img/rrss_post_1.png') }}" 
                    alt="Post RRSS" 
                    class="rrss-cover mx-auto"
                >
            </div>
            <div class="img-container mb-8 border border-black-100 rounded-md">
                <img 
                    src="{{ asset('img/rrss_post_2.png') }}" 
                    alt="Post RRSS" 
                    class="rrss-cover mx-auto"
                >
            </div>
