...
@section('content')
    ...
    <section class="about-banner py-14 px-4 bg-white">
        <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 grid-rows-1 text-center md:text-left mb-6 md:mb-10">
        ...
        <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 grid-rows-1 text-center md:text-left">
    ...
    <section class="services-banner container-2xl mx-auto py-14 px-4">
    ...
    <section class="testimonials-banner container-2xl mx-auto py-14 px-4">
        <div class="grid grid-cols-1 grid-rows-1 text-center mb-6">
            <h2 class="font-heading text-heading-h3 text-gray-title font-black mb-4">
    ...
    <section class="rrss-banner container-2xl mx-auto py-14 px-4">
        <div class="grid grid-cols-1 grid-rows-1 text-center mb-6">
            <h2 class="font-heading text-heading-h3 text-gray-title font-black mb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 grid-rows-3 md:grid-rows-1 md:mx-auto mb-8">
            <div class="img-container mb-8 mx-8 rounded-md">
    ...
    <section class="curiosity-banner container-2xl mx-auto py-14 px-4 bg-black-500">
        <div class="grid grid-cols-1 grid-rows-1 text-center mb-6">
