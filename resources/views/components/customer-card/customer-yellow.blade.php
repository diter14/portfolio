    ...
    <div class="grid grid-cols-1 md:grid-cols-12 grid-rows-1">
        <div class="card-customer-body md:col-span-7 text-center md:text-left">
            ...
            <div class="card-buttons absolute md:static bottom-8 left-0 w-full">
                <a href="{{ $customer['link_process'] }}" target="_blank" class="bg-yellow-500 text-black-500 font-heading font-bold rounded-full mx-auto mr-2 md:mr-4 py-2 md:py-1 px-4">
                    Ver presentación >
                </a>
                <a href="{{ $customer['link_web'] }}" class="font-heading text-black-400 bg-yellow-100 rounded-full mx-auto py-2 md:py-1 px-4">
                    Visitar Sitio
                </a>
            </div>
        </div>
