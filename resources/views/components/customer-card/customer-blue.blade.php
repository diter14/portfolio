    ...
    <div class="grid grid-cols-1 md:grid-cols-12 grid-rows-1">
        <div class="card-customer-body md:col-span-7 text-center md:text-left">
            ...
            <div class="card-buttons absolute md:static bottom-8 left-0 w-full">
                <a href="{{ $customer['link_web'] }}" target="_blank" class="bg-blue-500 text-white font-heading font-bold rounded-full mx-auto mr-2 md:mr-4 py-2 md:py-1 px-4">
                    Visitar Sitio >
                </a>
                <a href="#" class="font-heading text-blue-800 bg-blue-100 rounded-full mx-auto py-2 md:py-1 px-4">
                    Ver proceso
                </a>
            </div>
        </div>
